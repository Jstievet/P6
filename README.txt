...
- à éxécuté dans le terminal gitbash : 	- cd frontend
			       		- npm i
			       		- npm start
			       		...
			       		- npm i 
			       		- npm start
- création à la racine du dossier backend d'un fichiers .env qui dois contenir les différents clé présente dans le fichier .sample ( fichier contenant le nom des variables sans leur valeur associé) .je vous enverrai les informations à fournir au fichier .env car ce sont des informations senssible .
**************************************************************************
Auteurs :
__________________
Paula Z
